...
### 4.2 프로젝트 관리 및 네비게이션 ✅ 완료
- [x] **프로젝트 목록 페이지** ✅
  - 프로젝트 카드 목록 표시
  - 프로젝트 생성 모달
  - 프로젝트명 + 산업군 선택 (생성 시)
  - 파일: [ProjectListPage.js](../frontend/src/pages/ProjectListPage.js)

- [x] **프로젝트 레이아웃 + 3단계 네비게이션** ✅
  - 1단계: 이슈풀 생성
  - 2단계: 설문조사 (준비중)
  - 3단계: 중요이슈 선정 (준비중)
...
- **M1 (2주)**: Phase 0 완료 ✅
- **M2 (4주)**: Phase 1 완료 (이슈풀 구축 기능) - **진행 중 (Phase 1.1, 1.2 완료, 1.3-1.4 남음)**
